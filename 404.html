						...
						<form method="post" action="email_process.php">
							<div class="row uniform 50%">
								<div class="6u 12u$(xsmall)">
									<input type="text" name="name" id="name" value="" placeholder="Name" required="Enter your Name Please" />
								</div>
								<div class="6u$ 12u$(xsmall)">
									<input type="email" name="email" id="email" value="" placeholder="Email" required="Enter an Email address please" />
								</div>
								<div class="12u$">
									<textarea name="message" id="message" placeholder="Enter your message" rows="6" required="Please write us a message"></textarea>
								</div>
								<div class="12u$">
									<ul class="actions">
